...
namespace RealEstateManagement.Controllers
{
    public class BuilderController : Controller
    {
        ...
        public BuilderController(RealestatemanagementContext context, IWebHostEnvironment hostingEnvironment)
        {
            _context = context;
     ...
     .Any(ur => ur.UserId == userId && ur.Role.RoleName == "Builder");
            ...
            var properties = _context.Properties
                .Where(p => p.BudderId == userId)
                .OrderByDescending(p => p.CreatedDate)
                .ToList();

            var totalEnquiries = _context.Enquiries
    .Where(e => e.Property != null && e.Property.BudderId == userId)
    .Count();

            var totalVisits = _context.Sitevisits
    .Where(sv => sv.Property != null && sv.Property.BudderId == userId)
    .Count();
        ...
        public IActionResult AddProperty(Property model, IFormFile mainImage)
        {
            ...
            LogActivity(userId, "Property Added", "Property", model.PropertyId, $"Property '{model.PropertyTitle}' added by builder");
     ...
     .ToList();
        ...
        public IActionResult RespondToEnquiry(int enquiryId, string response)
        {
            ...
            var property = _context.Properties.FirstOrDefault(p => p.PropertyId == enquiry.PropertyId && p.BudderId == userId);
    ...
    .ToList();
        ...
        public IActionResult UpdateVisitStatus(int visitId, string status)
        {
            ...
            var property = _context.Properties.FirstOrDefault(p => p.PropertyId == visit.PropertyId && p.BudderId == userId);
        ...
        public IActionResult UpdateProfile(User model)
        {
            ...
            LogActivity(userId, "Profile Updated", "User", userId, "Builder profile updated");
